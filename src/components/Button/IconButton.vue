<template>
  <div :class="getClassNames" @click="clickButton">
    <slot>
      <slot name="icon">
...
export default defineComponent({
  ...
  computed: {
    getClassNames () {
      ...
      switch (this.type) {
        case 'primary': classNames.push('components-icon-button-primary'); break
        case 'success': classNames.push('components-icon-button-success'); break
        case 'danger': classNames.push('components-icon-button-danger'); break
        case 'warning': classNames.push('components-icon-button-warning'); break
        case 'info': classNames.push('components-icon-button-info'); break
      }
      if (this.disabled) {
